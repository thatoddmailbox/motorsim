...
export const COLOR_CURRENT = 0xffff00;
export const COLOR_TORQUE = 0xff00ff;
...
export const COLOR_BATTERY_POSITIVE = 0xc98959;
export const COLOR_BATTERY_LABEL = 0x111111;
export const COLOR_BATTERY_NEGATIVE = 0x333333;
export const COLOR_BRUSH_HOLDER = 0xcccccc;
export const COLOR_MAGNET_NORTH = 0xff0000;
export const COLOR_MAGNET_SOUTH = 0x0000ff;
export const COLOR_PLATFORM = 0xaaaaaa;

// we say that 2 units is about 1/12 of a meter
export const METERS_TO_UNITS = 24; // 2/(1/12)